...
2);
            ...
            Toast.makeText(CameraPreview.this, "Camera2 API not supported on this device", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(CameraPreview.this, "ERROR: Camera permissions not granted", Toast.LENGTH_LONG).show();
            }
        } else {
...
*
    ...
    private void showToast(final String text) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(CameraPreview.this, text, Toast.LENGTH_SHORT).show();
            }
        });
    }
<<<<<<< HEAD
